...
async def on_message(message):
    ...
    if message.content == '!사용법':
        await message.channel.send('```모르는 것이 있으면 아!루를 출력합니다.\n몰?루 혹은 ㅁ?ㄹ를 입력하면 아!루콘을 올립니다.```')
    ...
    if '몰?루' in message.content:
        ...
        else: await message.channel.send('I!know')
        if '¿' in message.content:
        ...
        await message.channel.send('아!루')
        ...
        if '모르간' in message.content:
            return None
        else: await message.channel.send('아!루')
